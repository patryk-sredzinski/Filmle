...
const mysteryYear = document.getElementById('mysteryYear');
const mysteryYearArrow = document.getElementById('mysteryYearArrow');
const mysteryBudget = document.getElementById('mysteryBudget');
const mysteryBudgetArrow = document.getElementById('mysteryBudgetArrow');
const mysteryRevenue = document.getElementById('mysteryRevenue');
const mysteryRevenueArrow = document.getElementById('mysteryRevenueArrow');
const mysteryGenres = document.getElementById('mysteryGenres');
const mysteryCompanies = document.getElementById('mysteryCompanies');
const mysteryCountries = document.getElementById('mysteryCountries');
const mysteryCast = document.getElementById('mysteryCast');
const mysteryDirector = document.getElementById('mysteryDirector');
// Initialize game
async function init() {
...
function updateMysteryInfo() {
    if (!mysteryMovie || allGuesses.length === 0) {
        ...
        if (mysteryYearArrow)
            mysteryYearArrow.textContent = '';
        if (mysteryBudget)
            mysteryBudget.textContent = '?';
        if (mysteryBudgetArrow)
            mysteryBudgetArrow.textContent = '';
        if (mysteryRevenue)
            mysteryRevenue.textContent = '?';
        if (mysteryRevenueArrow)
            mysteryRevenueArrow.textContent = '';
        if (mysteryGenres)

...
function compareMovies(guessed, mystery) {
    ...
    const yearResult = guessedYear === 0 || mysteryYear === 0 ? 'unknown' :
    ...
    const budgetResult = guessedBudget === mysteryBudget ? 'match' : (guessedBudget > mysteryBudget ? 'higher' : 'lower');
    const guessedRevenue = guessed.revenue || 0;
    const mysteryRevenue = mystery.revenue || 0;
    const revenueResult = guessedRevenue === mysteryRevenue ? 'match' : (guessedRevenue > mysteryRevenue ? 'higher' : 'lower');
